...
if salario <= 0:
    ...
    resposta = f'Seu salário era de R$ {salario:.2f} e passará a ser R$ {salario_futuro:.2f}'
elif salario <= 1000:
    salario_futuro = salario + (salario * 0.1) # 0.1 corresponde a 10%
    resposta = f'Seu salário é R$ {salario:.2f} e passará a ser R$ {salario_futuro:.2f}'
else:
