...
print('-' * 70)
print('ESTRUTURA DE DADOS: List Comprehesions []')
print('=' * 70)
...
# List Comprehensions
lista_com_juros_2 = [valor + (valor * .10) for valor in lista_precos if valor < 300]
print('Aplicar juros em condicional: List Comprehesions')
