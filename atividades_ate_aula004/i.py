...
conversao_dolar_real = valor_dolar * valor_real
conversao_real_dolar = valor_real / valor_dolar

# Saída
print('-' * 70)
print('--- CONVERSÃO DE VALORES')
print('=' * 70)
print(f'$ {valor_real:.2f} dólar(es) corresponde a: R$ {conversao_dolar_real:.2f} e '
      + f'R${valor_real:.2f} correspondem a: $ {conversao_real_dolar:.2f}' 
      + f'(dólares)')