...
print('-' * 70)
print('ESTRUTURA DE DADOS: LISTAS FATIAMENTO [ ]')
print('=' * 70)
...
print(f'Fatiamento uma Lista: {lista_fatiada1}\n')
print(f'Fatiamento uma Lista: {lista_fatiada2}\n')
print(f'Fatiamento uma Lista: {lista_fatiada3}\n')
print(f'Fatiamento uma Lista: {lista_fatiada4}\n')
print(f'Fatiamento uma Lista: {lista_fatiada5}\n')
